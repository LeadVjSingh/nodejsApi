...
describe('FizzBuzz algorithm', function() {
  ...
  it('should return FizzBuzz for counts which are multiple of both factors', function() {
    expect(fizzbuzz(15)).to.equal('FizzBuzz');
    expect(fizzbuzz(75)).to.equal('FizzBuzz');
  });

  it('should return the count itself when not a multiple of these factors', function() {
